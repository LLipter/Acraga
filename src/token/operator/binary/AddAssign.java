...
public class AddAssign extends BinaryOperator {
    ...
    public Value execute(DataStack context) throws RTException, ReturnValue {
        ...
        Value castedValue = Casting.casting(res, lvalue.getValueType());
        if(castedValue == null)
            throw new RTException(getLines(), getPos(), "not compatible data type");

        context.setValue((Identifier)lChild, castedValue);
